...
function ProductDetail() {
    ...
    return (
        <div className={cx('container')} style={{ padding: '50px 0' }}>
            <Row>
                ...
                <Col xs="6">
                    <div className={cx('content-product')}>
                        <h3 className={cx('heading')}>Áo Polo Nam Dylen vải Jacquard phom Regular Fit</h3>
                        ...
                        <p>
                            <span>{helper.formatMoney(299000)}</span> Giá niêm yết {helper.formatMoney(350000)}
                        </p>
                        <div>
                            <FontAwesomeIcon icon={faTape} className={cx('icon-size')} />
                            <span>Hướng dẫn chọn size áo</span>
                        </div>
                        ...
                        <Button variant="primary" className={cx('btn-add')}>
